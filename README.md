...
我们实测了一些业界知名的VPN，根据各个指标的实际表现，我们推荐了几家2019在中国最好用的VPN翻墙软件，并且这几家VPN都有30天内退款保证。由于每家VPN在特殊时期都不能保证完全稳定，所以本文会定期更新，推荐当前中国还能用的VPN。

今年国庆期间，使用自己搭建的SSR几乎全部被封了，因为有太多人在某几家VPS服务商上面都搭建了翻墙软件，导致一旦某个IP的流量被检测到SSR的指纹，这个IP段的用户都会被封，国内到国外的TCP和UDP数据包均不能正常发送。如果只是为了翻墙，而不是对翻墙技术有兴趣想去实践的话，我们建议还是推荐购买付费VPN更加省事儿，免得特殊时期又会面临没有梯子的尴尬。付费VPN之所以不会面临自建SSR的问题，是因为他们通常在全球范围内都租用了大量的VPN服务器，就算几台IP被封也能够快速切换到其他服务器，不会影响用户的正常使用。
...
PureVPN也是一家老牌商家，可以在购买页面选择中文，网络速度和稳定性目前来说仅次于ExpressVPN，价格方面相对ExpressVPN便宜一些，但是如果有条件还是尽量选择[ExpressVPN](http://qiangwaikan.com/go/express)
